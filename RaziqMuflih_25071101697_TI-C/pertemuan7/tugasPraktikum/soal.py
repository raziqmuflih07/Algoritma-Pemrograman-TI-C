...
print("bubble sort(kecil -> besar) : ",python_data)
print("\njumlah swap bubble sort : ",swap_bubble)
...
for i in range(n):
  ...
  for j in range(i+1,n):
     if data_baru[j] > data_baru[max_index]:
       max_index = j
  data_baru[i], data_baru[max_index] = data_baru[max_index], data_baru[i]
  swap_selection += 1

print("\nselection sort(besar -> kecil) : ",data_baru)
print("\njumlah swap selection sort : ",swap_selection)
